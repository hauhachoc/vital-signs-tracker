...
//for debug purpose only
            ...
            if (response.equals("Success")) {
				...
				alertDialog.setMessage("Press 'Continue' to Sign-In");
				...
				Toast.makeText(this, "fail to insert to DB", Toast.LENGTH_LONG).show();
				
				AlertDialog alertDialog = new AlertDialog.Builder(this).create();
				alertDialog.setTitle("Registration Failed");
				alertDialog.setMessage("Email found in Database. Use other email account.");
				alertDialog.setButton("Continue", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface d, int i) {
						uiemailField.setText("");
						uiemailField.setSelection(0);						
					}
				});
				alertDialog.show();
			}
